...
class Rapshelter extends Component {
    ...
    render() {
        ...
        // for (let i = 0; i < this.state.perrapot.mapel.lenght; i++) {
        //     nilai.push(
        //         <View key={i}>
        //             <View>
        //                 <View>
        //                     <View style={{ flexDirection: 'row' }}>
        //                         <Text style={style.labelkiri}>{this.state.perrapot.mapel[i]}</Text>
        //                         <Text style={[style.labelkanan, { marginLeft: 50 }]}>{this.state.perrapot.nilai[i]}</Text>
        //                     </View>
        //                 </View>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <TouchableOpacity onPress={() =>
                            ...
                            //     { tot: item, detak: item, list: item, nama: this.props.route.params.item, })
                        }
                        >
