                    ...
                    this.props.user.presensi === 'pengelola' ? //ini untuk tampilan pengelola//
                        <SafeAreaView contentContainerStyle={style.contentContainer} showsVerticalScrollIndicator={false}>
                            ...
                            {/* <ScrollView horizontal={true}>
                                <View style={{ justifyContent: 'space-between', flexDirection: 'row', textAlign: 'center', alignContent: 'space-between', alignItems: 'center' }}>
                                    <TouchableOpacity style={style.pencarian} onPress={() => { this.setState({ sa: true }) }}>
                                        <Text style={{ textAlign: 'center', color: '#000', padding: 10, fontFamily: 'Poppins-SemiBold', }}>Semua Anak</Text>
                                    </TouchableOpacity>

                                    <TouchableOpacity style={style.pencarian} onPress={() => { this.setState({ st: true }) }}>
                                        <Text style={{ textAlign: 'center', padding: 10, color: '#000', fontFamily: 'Poppins-SemiBold', }}>Semua Tanggal</Text>
                                    </TouchableOpacity>

                                    <TouchableOpacity style={style.pencarian} onPress={() => { this.setState({ jk: true }) }}>
                                        <Text style={{ textAlign: 'center', color: '#000', padding: 10, fontFamily: 'Poppins-SemiBold', }}>Jenis Kelamin</Text>
                                    </TouchableOpacity>
                                </View>
                            </ScrollView> */}
                            ...
                            <View style={{ position: 'absolute', top: 570, marginLeft: 340, alignItems: 'center' }}>
                                {/* <TouchableOpacity onPress={() => this.props.navigation.navigate('Pilnak')} style={style.refresh} >
                            <View style={{
                                ...
                                <Text style={{ color: '#fff', textAlign: 'center', justifyContent: 'center', alignContent: 'center' }}>+ Tambah Anak </Text>
                            </View>
                        </TouchableOpacity> */}
                                <ActionButton buttonColor='#00A9B8' offsetX={5}>
                                    <ActionButton.Item
                        ...
                        {/* <TouchableOpacity onPress={() => this.props.navigation.navigate('Pilnak')} style={style.refresh} >
                            ...
                            {/* <ActionButton buttonColor='#00A9B8' style={{position:'absolute'}}>
                         <ActionButton.Item buttonColor='#00A9B8' title="Ajukan Pencarian Dana" onPress={() => {}}>
                             <Image source={floatbtnapd} style={style.actionButtonIcon} />
                         </ActionButton.Item>
                         <ActionButton.Item buttonColor='#00A9B8' title="Tambah Anak Binaan" onPress={() => {}}>
                             <Image source={floatbtntab} style={style.actionButtonIcon} />
                         </ActionButton.Item>
                         </ActionButton> */}
                            {/* </View> */}
                            {/* //ditaruh di flatlist untuk menggantikan ketika masih belum ada data// */}
