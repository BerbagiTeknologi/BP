...
class Tamrap extends Component {
  ...
  render() {
    ...
    // const terbaru1 = this.state.detanak.filter(function (result) {
    //   return result.tingkat === rap;
    ...
    <TouchableOpacity
      ...
      <View style={style.kotakabu2}>
        ...
        <View
          ...
          <View style={{ flexDirection: 'column' }}>
            <Text style={style.labelbaru3}>Kelas I</Text>
            <Text style={style.labelbaru4}>Semester II/Ganjil</Text>
          </View>
          ...
          <ScrollView >
            ...
            {/* <View style={style.kotakabu}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                <View style={{ flexDirection: 'column' }}>
                  <Text style={style.labelbaru}>{detail.kelas}</Text>
                  <Text style={style.labelbaru2}>{detail.tingkat}</Text>
                </View>
                <View style={{ flexDirection: 'column' }}>
                  <Text style={style.labelbaru1}>{detail.tanggal}</Text>
                  <Text> 10.45</Text>
                </View>
              </View>
            </View> */}
              ...
              this.state.show === 1 && this.state.rap === 'SD/MI' ?
                <View>
                  ...
                  <View style={style.kotakabu}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                      <View style={{ flexDirection: 'column' }}>
                        <Text style={style.labelbaru}>Kelas I</Text>
                        <Text style={style.labelbaru2}>Semester II/Ganjil</Text>
                      </View>
                      <View style={{ flexDirection: 'column' }}>
