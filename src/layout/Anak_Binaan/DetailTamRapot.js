...
class DetailTamRapot extends Component {
  ...
  SimpanData() {
    AsyncStorage.getItem('token').then((token) => {
      ...
      let dataToSend = {
        ...
        // foto:encodeURIComponent( JSON.stringify( this.state.foto.name === '' ? '' : this.state.foto )),
        // this.state.foto.name === '' ? '' : this.state.foto,
        // foto: encodeURIComponent( JSON.stringify( this.state.rapimg )),
        //  foto: encodeURIComponent( JSON.stringify( this.state.convert )),
  ...
  //       style={style.scanner}
  //       onPictureTaken={this.state.setData}
  ...
  //     />
  //     <TouchableOpacity onPress={this.handleOnPress()} style={style.button}>
  ...
  //     return (
  //       <View>
  //         <Image source={{ uri: data.croppedImage }} style={style.preview} />
  //         <TouchableOpacity onPress={handleOnPressRetry} style={style.button}>
            ...
            <SafeAreaView>
              <>
                <View>
                  ...
                  {/* <TouchableOpacity onPress={this.lifi1()}>
                    <Text>adawdafaw</Text>
                  </TouchableOpacity> */}
                  <ScrollView horizontal={true} style={{ marginHorizontal: 10, marginVertical: 8 }} >
                    <>
                      {/* <Image style={{width: 150, height: 150}} source={{uri: base64Icon}}/>
                        <Image source={this.state.foto} style={{ width: 150, height: 150 }} />
                        <Image source={{uri: `data:image/png;base64,${this.state.convert}`}} /> */}
                      {/* {this.state.foto} */}
...
{/* <View style={{ marginBottom: 10, marginTop: 10 }}>
  ...
  {this.state.foto1.name != '' && this.state.foto2.name != '' ? (
    <TouchableOpacity
      onPress={() => {
        Alert.alert(
          'Info',
  ...
  {this.state.foto1.name != '' && this.state.foto2.name != '' && this.state.foto3.name != '' ? (
    <TouchableOpacity
      onPress={() => {
        Alert.alert(
          'Info',
