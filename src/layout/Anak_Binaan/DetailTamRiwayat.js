              ...
              <View>
                ...
                {/* <View>
                  ...
                  <View style={{ marginTop: 5, height: 600 }}>
                    <View style={{ borderColor: '#DDD', borderWidth: 1, height: 55, width: '100%', borderRadius: 10, top: 18, position: 'absolute' }} />
                    <Picker
                      style={style.Textinputcss2}
                      selectedValue={this.state.JR}
                      onValueChange={itemValue =>
                        this.setState({ JR: itemValue, show: 1 })
                      }>
                      <Picker.Item style={{ fontSize: 14, fontFamily: 'Poppins-Regular' }} label="Jenis Histori" value="" />
                    ...
                    <View >
                      ...
                      <View style={style.header}>
                        <TouchableOpacity onPress={() =>
                          Alert.alert(
                            ...
                            [
                              ...
                              { text: 'Galeri', onPress: () => this.takePicGal(this.state.img1 === null ? 0 : this.state.img1 + 1) },
                              {
                                text: "Cancel",
                        ...
                        >
                          ...
                          <View style={{ backgroundColor: '#00A9B8', borderRadius: 10, marginTop: 100, padding: 10 }}>
                            <Text style={{ color: '#fff', fontFamily: 'Poppins-Medium', fontSize: 13 }}>+ Tambah Foto Riwayat</Text>
                          </View>
        ...
        {/* <Modal visible={this.state.simpan}>
          <View style={{ backgroundColor: '#fff', borderRadius: 10, height: '23%', width: '80%', alignSelf: 'center', alignItems: 'center', flexDirection: 'column', justifyContent: 'space-between', padding: 30 }}>
            ...
            <View style={{ alignItems: 'center', flexDirection: 'row', alignContent: 'center' }}>
              ...
              <View style={{ width: 20 }} />
              <TouchableOpacity onPress={() => this.props.navigation.navigate('SuratCinta') + ToastAndroid.show('Data Berhasil Disimpan', ToastAndroid.SHORT)}>
