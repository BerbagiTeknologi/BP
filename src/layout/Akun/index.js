...
export class Akun extends Component {
 ...
 {this.props.user.presensi === 'karyawan' ? //admin cabang
  ...
  {/* <TouchableNativeFeedback onPress={() => ToastAndroid.show('Pelatihan Tutor Diklik', ToastAndroid.SHORT)}>
    <View style={{ marginTop: '4%', flexDirection: 'row', width: '100%', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: '8%' }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', }}>
        <IconBook />
              ...
              <View style={style.ModalCont2}>
                <View style={{
                  ...
                  <SafeAreaView style={{ width: '100%', height: '100%' }}>
                    ...
                    {/* <View style={style.btnBaru}>
                      <TouchableOpacity onPress={() => { this.setState({ dd: false }) }} style={{ flexDirection: 'row' }}>
                        <Text style={{ color: '#fff', marginLeft: 10, fontSize: 16 }}>Simpan</Text>
                      </TouchableOpacity>
                    </View> */}
                  </SafeAreaView>
                </View>
...
//   <View style={{padding:5,flexDirection:'row',justifyContent:'space-around',alignSelf:'center',marginTop:'20%',borderRadius:10,marginHorizontal:10,backgroundColor:'#EBEAEA',width:'73%' }}>
//     <TouchableOpacity style={{backgroundColor:'#fff',width:'45%',height:'90%',borderRadius:10,marginTop:1}}>
//       <Text style={{justifyContent:'center',textAlign:'center',alignSelf:'center',alignContent:'center',alignItems:'center',padding:10}}>Profil</Text>
    
    
//     </TouchableOpacity>
//     <TouchableOpacity style={{width:'45%',height:'90%',borderRadius:10,}}>
//       <Text style={{justifyContent:'center',textAlign:'center',alignSelf:'center',alignContent:'center',alignItems:'center',padding:10}}>Riwayat</Text>
//     </TouchableOpacity>
//   </View>
...
//     </View>
//   </TouchableNativeFeedback>
//   <TouchableNativeFeedback onPress={() => this.props.navigation.navigate('AktifitasTutor')}>
//     <View style={{ marginTop: '4%', flexDirection: 'row', width: '100%', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: '8%' }}>
//       <View style={{ flexDirection: 'row', alignItems: 'center' }}>
//         <IconAktifitas />
//         <Text style={{ left: '45%', color: '#000', fontFamily: 'Poppins-Medium', fontSize: 14, right: '30%' }}>Aktivitas Tutor</Text>
...
//   </View>
//   <View style={{ marginTop: 40, borderWidth: 1, height: 60, width: 250, borderRadius: 10, justifyContent: 'center', alignItems: 'center', alignContent: 'center', alignSelf: 'center', borderColor: '#00A9B8', }}>
//     <TouchableOpacity onPress={this.logout} style={{ flexDirection: 'row' }}>
//       <Image source={luar}></Image>
//       <Text style={{ color: '#00A9B8', marginLeft: 10, fontSize: 16 }}>Keluar Akun</Text>
//     </TouchableOpacity>
