import { Text, View, TextInput, TouchableOpacity, ScrollView, StyleSheet, Dimensions, Modal, Alert } from 'react-native'
...
export class editdatawali extends Component {
  constructor(props) {
    super(props);
    this.state = {
      detail: this.props.route.params.detail,
      nikwali: this.props.route.params.detail.nik_wali,
      namawali: this.props.route.params.detail.nama_wali,
      ...
      date: new Date(),
      chosenDate: this.props.route.params.detail.tanggal_lahir,
      prov: [],
      ...
      hubker: this.props.route.params.detail.hub_kerabat,
      modaldate: false,
    };
  }
  GetprovAPi() {
  ...
  editData() {
    {
      ...
      fetch('https://kilauindonesia.org/datakilau/api/waliupd/' + this.state.detail.id_keluarga, {
        method: 'POST',
        headers: {
  ...
  onPress = () => {
    ...
    const birth = moment(this.state.chosenDate).format('DDMMYY')
    ...
    if (tanggal != moment(this.state.chosenDate).format('DDMMYY')) {
      Alert.alert(
        'Peringatan Data yang anda isi ',
    ...
    if (dodol == this.state.id_prov && kabu == this.state.id_kab && keca == this.state.id_kec && tanggal == moment(this.state.chosenDate).format('DDMMYY')) {
      Alert.alert(
        'Peringatan Data yang anda isi ',
  ...
  render() {
    ...
    return (
      <ScrollView style={{ backgroundColor: '#fff', flex: 1 }}>
        <Text style={{ textAlign: 'center', fontSize: 16, fontWeight: 'bold', marginTop: 10 }}>Edit Data Wali</Text>
        <View>
          <Text style={style.labelatas}>Data Keluarga</Text>
          <View style={{ justifyContent: 'center' }}>
            <View style={style.form}>
              <Text style={style.labelkiri}>NIK wali</Text>
              <TextInput
            ...
            <View style={style.form}>
              ...
              <TextInput
                ...
                keyboardType='default'
                placeholder={detail.tanggal_lahir}
                placeholderTextColor="#C0C0C0"
              />
              <View
                style={{
            ...
            <View style={style.form}>
              ...
              <View
                ...
                <Picker
                  ...
                  <Picker.Item style={{ fontSize: 12 }} label={detail.provinsi} value={'0'} key={'0'} />
                  {
            ...
            <View style={style.form}>
              ...
              <View
                ...
                <Picker
                  ...
                  {/* <Picker.Item style={{ fontSize: 12 }} label={detail.id_prov === null ? 'Pilih Provinsi' : detail.nama_prov} value={'0'} key={'0'} /> */}
                  <Picker.Item style={{ fontSize: 12 }} label={detail.kelurahan} value={''} key={''} />
                  {
            ...
            <View style={style.form}>
              <Text style={style.labelkiri}>Hubunagn Kerabat</Text>
              <View
                style={style.kotakpicker}>
                <Picker style={style.Textinputcss}
                  selectedValue={this.state.hubker}
                  // value={this.state.hubker}
                  onValueChange={(itemValue,) => {
                    this.setState({
                      hubker: itemValue
                    })
                  }}>
                  <Picker.Item style={{ fontSize: 12 }} label={detail.hub_kerabat} value={''} key={''} />
                  <Picker.Item style={{ fontSize: 12 }} label="Kakak" value="kakak" />
                  <Picker.Item style={{ fontSize: 12 }} label="Saudara dari Ayah" value="saudara_ayah" />
                  <Picker.Item style={{ fontSize: 12 }} label="Saudara dari Ibu" value="saudara_ibu" />
                  <Picker.Item style={{ fontSize: 12 }} label="Tidak Ada Hubungan Kerabat" value="tdk_ada_hub" />
                </Picker>
              </View>
            </View>
            ...
            <View style={{ justifyContent: 'center', alignContent: 'center', alignItems: 'center', alignSelf: 'center', marginTop: 0, }}>
              <TouchableOpacity onPress={() => this.onPress()} style={style.refresh} >
                <View style={{
                  top: 20,
