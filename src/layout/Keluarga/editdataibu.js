...
export class editdataibu extends Component {
    constructor(props) {
        super(props);
        this.state = {
            detail: this.props.route.params.detail,
            nik_ibu: this.props.route.params.detail.nik_ibu,
            nama_ibu: this.props.route.params.detail.nama_ibu,
    ...
    editData() {
        {
            let simpandata = {
                ...
                tanggal_lahir: moment(this.state.chosenDate1).format('YYYY-MM-DD'),
                alamat: this.state.alamat,
                id_prov: this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ? '' : this.state.id_prov,
                id_kab: this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ? '' : this.state.id_kab,
                id_kec: this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ? '' : this.state.id_kec,
                id_kel: this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ? '' : this.state.id_kel,
                penghasilan: this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ? '' : this.state.penghasilan,
                tanggal_kematian: this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ? moment(this.state.chosenDate2).format('YYYY-MM-DD') : '',
                penyebab_kematian: this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ? this.state.penyebab_kematian : '',
            ...
            fetch('https://kilauindonesia.org/datakilau/api/ibuupd/' + this.state.detail.id_keluarga, {
                method: 'POST',
                headers: {
    ...
    componentDidMount() {
        ...
        this.GetkecAPi();
        this.GetkelAPi();
        console.log(this.state.id_prov, this.state.id_kab, this.state.id_kec, this.state.id_kel, this.state.detail);
    }
    showPicker1 = () => {
    ...
    handlePicker1 = (date) => {
        this.setState({ isVisible1: false, chosenDate1: moment(date).format('DD-MM-YYYY') })
    }
    handlePicker2 = (date) => {
        this.setState({ isVisible2: false, chosenDate2: moment(date).format('DD-MM-YYYY') })
    }
    onPress = () => {
        const didin = this.state.nik_ibu;
    ...
    render() {
        ...
        return (
            <ScrollView style={{ backgroundColor: '#fff', flex: 1 }}>
                <Text style={{ textAlign: 'center', fontSize: 16, fontWeight: 'bold', marginTop: 10 }}>Edit Data Ibu</Text>

                <Text style={style.labelatas}>Data Keluarga </Text>
                <View style={{ justifyContent: 'center' }}>
                    {this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ?
                        <View /> :
                        <View style={style.form}>
                            <Text style={style.labelkiri}>NIK Ibu</Text>
                            <TextInput
                                style={[style.kotak3, { backgroundColor: '#c0c0c0' }]}
                                onChangeText={nik_ibu => this.setState({ nik_ibu })}
                                value={this.state.nik_ibu}
                    ...
                    <View style={style.form}>
                        ...
                        <TextInput
                            style={style.kotak3}
                            onChangeText={nama_ibu => this.setState({ nama_ibu })}
                    ...
                    <View style={style.form}>
                        ...
                        <Text style={style.kotak3}>{this.state.chosenDate1}</Text>
                        <View
                            style={{
                                borderColor: '#DDD',
                                borderWidth: 1,
                    ...
                    <View style={style.form}>
                        ...
                        <View
                            ...
                            <Picker
                                ...
                                enabled={this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ? false : true}
                                onValueChange={(itemValue,) => {
                                    this.setState({
                                        id_prov: itemValue
                                    })
                                ...
                                <Picker.Item style={{ fontSize: 12 }} label={this.state.provinsi} value={'0'} key={'0'} />
                                {
                    ...
                    <View style={style.form}>
                        ...
                        <View
                            ...
                            <Picker
                                ...
                                {/* <Picker.Item style={{ fontSize: 12 }} label={detail.id_prov === null ? 'Pilih Provinsi' : detail.nama_prov} value={'0'} key={'0'} /> */}
                                <Picker.Item style={{ fontSize: 12 }} label={detail.kabupaten} value={'0'} key={'0'} />
                                {
                    ...
                    <View style={style.form}>
                        ...
                        <View
                            ...
                            <Picker
                                ...
                                onValueChange={(itemValue, datakota) => {
                                    this.setState({
                                        id_kec: itemValue
                                    })
                                }}>
                                {/* <Picker.Item style={{ fontSize: 12 }} label={detail.id_prov === null ? 'Pilih Provinsi' : detail.nama_prov} value={'0'} key={'0'} /> */}
                                <Picker.Item style={{ fontSize: 12 }} label={detail.kecamatan} value={'0'} key={'0'} />
                                {
                    ...
                    <View style={style.form}>
                        ...
                        <View
                            ...
                            <Picker
                                ...
                                onValueChange={(itemValue, datakec) => {
                                    this.setState({
                                        id_kel: itemValue
                                    })
                                }}>
                                {/* <Picker.Item style={{ fontSize: 12 }} label={detail.id_prov === null ? 'Pilih Provinsi' : detail.nama_prov} value={'0'} key={'0'} /> */}
                                <Picker.Item style={{ fontSize: 12 }} label={this.state.detail.kelurahan} value={'0'} key={'0'} />
                                {
                    ...
                    <View style={style.form}>
                        <Text style={style.labelkiri}>Penghasilan {this.props.route.params.detail.status_ortu}</Text>
                        <View
                            style={style.kotakpicker}>
                    ...
                    {this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ?
                        <View>
                            ...
                            <View style={style.form}>
                                ...
                                <Text style={style.kotak3}> {this.state.chosenDate2}</Text>
                                <View
                                    style={{
                                        borderColor: '#DDD',
                                        borderWidth: 1,
                    ...
                    <View style={{ justifyContent: 'center', alignContent: 'center', alignItems: 'center', alignSelf: 'center', marginTop: 0, }}>
                        <TouchableOpacity onPress={() =>
                            this.state.ortu === 'Yatim_Piatu' | this.state.ortu === 'Piatu' ?
                                this.editData() :
                                this.onPress()} style={style.refresh} >
                            <View style={{
                                top: 20,
